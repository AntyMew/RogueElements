// <copyright file="AddSpecialRoomTest.cs" company="Audino">
// Copyright (c) Audino
...
namespace RogueElements.Tests
{
    ...
    public class AddSpecialRoomTest
    {
        ...
        public class AddSpecialRoomTestStep : AddSpecialRoomStep<IFloorPlanTestContext>
        {
            ...
            public static Rect GetSupportRect(TestFloorPlan floorPlan, IRoomGen oldGen, IRoomGen newGen, Dir4 dir, List<RoomHallIndex> adjacentsInDir) => AddSpecialRoomStep<IFloorPlanTestContext>.GetSupportRect(floorPlan, oldGen, newGen, dir, adjacentsInDir);
        }
    }
}
